...
namespace BookMS.Migrations
{
    ...
    [Migration("20220419012508_InitialContext")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookMS.Models.Borrow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookMS.Models.Book", b =>
                {
                    b.HasOne("BookMS.Models.Author", "Author")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BookMS.Models.User", null)
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
